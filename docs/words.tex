...
\index{begin}\item[\index{again}begin ... again]
...
\index{while}\item[\index{repeat}begin ... while ... repeat]
...
\index{case}\item[\index{endcase}case ... endcase, \index{of}of ... \index{endof}endof] Switch statements.
