...
\index{hide}\item[hide xxx] Removes \texttt{xxx} from the word list, while leaving its definition in place.
\index{define}\item[define ( "name" -- ) ] Assign \texttt{here} as the execution token of word \texttt{name} and enter the compilation state.
